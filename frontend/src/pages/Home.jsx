...
import food from "../assests/food_img.PNG";
    ...
    <>
      ...
      <Box>
        <Box className="top-section">
          ...
          <Box className="mid-column">
            <Box className="container">
              ...
              >
                ...
                ingredients, and long activities with Calories Tracker.
              </Text>
              <Button
                colorScheme={"blue"}
          ...
          <Box className="right-column">fjjjjjjjjjjjjjjjjjjjjjjjjjjj</Box>
        </Box>
            ...
            <Box className="sixth-section-cards">
              ...
              <Box m={3}>
                <Text color={"blue"} fontWeight="bold">
                  <Link to={"#"}>Calories Tracker Blog</Link>
                </Text>
              </Box>
            </Box>
            <Box className="sixth-section-cards">
        ...
        {/* <Box className="seventh-section">
          ...
          <Box pt={{ base: 4, md: 6 }}>
            <Text fontSize={{ base: "md", sm: "xl" }}>
              Easily link your Calories Tracker account with apps that support your
              healthier lifestyle. It’s not just about calories. It’s about
              feeling better, looking better, and living better.
            </Text>
          </Box>
          <Box mt={[8, 16]}>
            <Image src="https://www.Calories Tracker.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fimg-apps%402x.85e549ef.png&w=1920&q=75" />
          </Box>
